        ...
        <div className="text-center mb-12">
          ...
          <div className="bg-red-500/20 border border-red-500/30 rounded-lg p-4 mb-6">
            ...
            <p className="text-red-300 text-sm leading-relaxed">
              By reacting to accept or using any features of this service, you agree to be bound by these Terms & Conditions in their entirety.
            </p>
          </div>
        </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8">
            ...
            <div className="text-purple-200 space-y-4">
              <ul className="space-y-3">
                ...
                <li>• All images and videos generated by this service are created at your explicit request</li>
            ...
            <div className="text-purple-200 space-y-4">
              <div>
                ...
                <ul className="space-y-2 ml-4">
                  <li>• All images and videos created through this service are subject to moderation</li>
              ...
              <div>
                ...
                <ul className="space-y-2 ml-4">
                  ...
                  <li>• Using this service to create non-consensual intimate imagery of any kind is forbidden</li>
              ...
              <div>
                ...
                <ul className="space-y-2 ml-4">
                  <li>• Do not use this serive to infringe upon copyrights, trademarks, or other intellectual property rights</li>
              ...
              <div>
                ...
                <ul className="space-y-2 ml-4">
                  ...
                  <li>• Using the service to spread misinformation or create deceptive media</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="text-purple-200 space-y-4">
              ...
              <div>
                ...
                <ul className="space-y-2 ml-4">
                  ...
                  <li>• This service may be modified, suspended, or terminated at any time without prior notice</li>
                </ul>
              </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8">
            ...
            <div className="text-purple-200 space-y-4">
              ...
              <div>
                ...
                <p>You agree to indemnify and hold harmless the applicaiton operators from any claims arising from your use of this service. We make no guarantees about the quality, accuracy, or appropriateness of generated content.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8">
            ...
            <div className="text-purple-200 space-y-3">
              <ul className="space-y-2 ml-4">
                ...
                <li>• Continued use of the services after changes constitutes acceptance of the revised terms</li>
