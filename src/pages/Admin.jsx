...
const Admin = () => {
    ...
    // Updated helper function to get video poster/thumbnail (matching Gallery.jsx)
    ...
    // Helper function to get thumbnail for text-based video tools (from Gallery.jsx)
...
const filenameFromUrl = (value) => {
  try {
    ...
    // Not a full URL; still try to grab last path segment
...
const formatConfigValue = (key, value) => {
  ...
  <div className="rounded-xl border border-white/10 bg-white/5 p-4">
    ...
    <div className="space-y-3 text-sm">
      ...
      <div className="grid grid-cols-12 gap-3 items-center">
        <span className="col-span-5 text-purple-200">Showcased</span>
        <span className="col-span-7 justify-self-end text-right">
