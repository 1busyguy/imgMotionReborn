    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-white/10 backdrop-blur-md rounded-2xl p-8 shadow-2xl">
                ...
                {requiresCaptcha && loginAttempts >= 3 && (
                    <div className="bg-amber-500/20 border border-amber-500 text-amber-100 px-4 py-3 rounded-lg mb-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* Show Turnstile CAPTCHA after failed attempts */}
                    {requiresCaptcha && (
