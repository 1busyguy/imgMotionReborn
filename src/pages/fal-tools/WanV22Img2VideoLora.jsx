...
const WanV22Img2VideoLora = () => {
    ...
    // ============= NEW FUNCTION TO HANDLE ASSET SELECTION =============
    const handleAssetSelection = async (asset) => {
        // Set the image URL from the selected asset
        setConfig(prev => ({ ...prev, imageUrl: asset.url }));

        // If it's an image, analyze it for motion prompt suggestions
        if (asset.type === 'image') {
            await analyzeImageWithOpenAI(asset.url);
        }

        // If the asset has metadata with a prompt, you could optionally use it
        if (asset.metadata?.prompt && !config.prompt) {
            // Optionally pre-fill the prompt from the original generation
            // setConfig(prev => ({ ...prev, prompt: asset.metadata.prompt }));
        }

        // Close the asset history modal
        setShowAssetHistory(false);

        // Show success message
        showAlert('success', 'Asset Selected', `Successfully loaded ${asset.isUpload ? 'upload' : 'generation'}: ${asset.name}`, true);
    };
    // ============= END NEW FUNCTION =============
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 overflow-x-hidden">
                        ...
                        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 sticky top-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    {/* ============= NEW ASSET HISTORY BUTTON ADDED ============= */}
                                    <div className="flex gap-2 mb-3">
                                        <button
                                            onClick={() => setShowAssetHistory(true)}
                                            className="flex-1 px-4 py-2 bg-violet-500/20 hover:bg-violet-500/30 border border-violet-400/50 text-violet-300 rounded-lg transition-colors flex items-center justify-center space-x-2"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="flex-1 px-4 py-2 bg-white/10 hover:bg-white/20 border border-white/30 text-white rounded-lg transition-colors flex items-center justify-center space-x-2"
                                        >
                                            <Upload className="w-4 h-4" />
                                            <span>Upload New</span>
                                        </button>
                                    </div>
                                    {/* ============= END NEW ASSET HISTORY BUTTON ============= */}
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-3 gap-2">
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-lg border transition-all ${config.resolution === '480p'
                                        ...
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-lg border transition-all ${config.resolution === '580p'
                                                    ? 'bg-violet-500/30 border-violet-400 text-white'
                                                    : 'bg-white/5 border-white/20 text-purple-200 hover:bg-white/10'
                                                }`}
                                        >
                                        ...
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-lg border transition-all ${config.resolution === '720p'
                                                    ? 'bg-violet-500/30 border-violet-400 text-white'
                                                    : 'bg-white/5 border-white/20 text-purple-200 hover:bg-white/10'
                                                }`}
                                        >
                                ...
                                <div>
                                    <div className="flex items-center justify-between mb-3">
                                        ...
                                        <button
                                            ...
                                            className={`px-3 py-1 rounded-lg text-xs font-medium transition-colors ${config.loras.length >= 2
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-3 gap-2">
                                        <button
                                            ...
                                            className={`px-3 py-2 rounded-lg text-sm font-medium transition-all ${config.aspectRatio === 'auto'
                                        ...
                                        <button
                                            ...
                                            className={`px-3 py-2 rounded-lg text-sm font-medium transition-all ${config.aspectRatio === '16:9'
                                                    ? 'bg-violet-500 text-white'
                                                    : 'bg-white/10 text-purple-200 hover:bg-white/20'
                                                }`}
                                        >
                                        ...
                                        <button
                                            ...
                                            className={`px-3 py-2 rounded-lg text-sm font-medium transition-all ${config.aspectRatio === '9:16'
                                                    ? 'bg-violet-500 text-white'
                                                    : 'bg-white/10 text-purple-200 hover:bg-white/20'
                                                }`}
                                        >
                                        ...
                                        <button
                                            ...
                                            className={`px-3 py-2 rounded-lg text-sm font-medium transition-all ${config.aspectRatio === '1:1'
                                                    ? 'bg-violet-500 text-white'
                                                    : 'bg-white/10 text-purple-200 hover:bg-white/20'
                                                }`}
                                        >
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        <button
                                            ...
                                            className={`px-3 py-2 rounded-lg text-sm font-medium transition-all ${config.interpolatorModel === 'film'
                                                    ? 'bg-violet-500 text-white'
                                                    : 'bg-white/10 text-purple-200 hover:bg-white/20'
                                                }`}
                                        >
                                        ...
                                        <button
                                            ...
                                            className={`px-3 py-2 rounded-lg text-sm font-medium transition-all ${config.interpolatorModel === 'rife'
                                                    ? 'bg-violet-500 text-white'
                                                    : 'bg-white/10 text-purple-200 hover:bg-white/20'
                                                }`}
                                        >
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        ...
                                        <button
                                            ...
                                            className={`px-3 py-2 rounded-lg text-sm font-medium transition-all ${config.acceleration === 'regular'
                                                    ? 'bg-violet-500 text-white'
                                                    : 'bg-white/10 text-purple-200 hover:bg-white/20'
                                                }`}
                                        >
            ...
            {/* ============= NEW ASSET HISTORY MODAL ADDED ============= */}
            <AssetHistory
                isOpen={showAssetHistory}
                onClose={() => setShowAssetHistory(false)}
                onSelect={handleAssetSelection}
                assetType="image" // Only show images for img2video tool
                title="Select an Image from Your Library"
                allowUploads={true}
            />
            {/* ============= END NEW ASSET HISTORY MODAL ============= */}
