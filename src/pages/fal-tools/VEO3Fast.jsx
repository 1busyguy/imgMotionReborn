...
const VEO3Fast = () => {
  ...
  const calculateTokenCost = () => {
    ...
    // Base cost depends on resolution and audio
    if (config.resolution === "1080p") {
      baseCost = config.generateAudio ? 1280 : 800;
    } else {
      // 720p
      baseCost = config.generateAudio ? 640 : 400;
    }
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Call Edge Function using direct fetch (same pattern as all working tools)
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-purple-200 text-sm">Ultra-fast text-to-video generation with VEO3 technology and audio</p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-purple-300 text-xs mt-1">
                    Example: A casual street interview on a busy New York City sidewalk
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    {resolutionOptions.map((option) => (
                      ...
                      >
                        {option.label} {option.value === "1080p" && "(+15 tokens)"}
                      </button>
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <label className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-purple-300 text-xs">Automatically improve prompt for better results</p>
                    </div>
                  </label>
                  ...
                  <label className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-purple-300 text-xs">
                        Add AI-generated audio to your video (+{config.resolution === "1080p" ? "480" : "240"} tokens)
                      </p>
                    </div>
                  </label>
                ...
                <div className="bg-violet-500/10 border border-violet-500/30 rounded-lg p-3">
                  <p className="text-violet-200 text-xs">
                    ...
                    VEO3 Fast generation may take 2-5 minutes. Pricing: 720p (400 tokens), 1080p (800 tokens), +Audio (+240/+480 tokens).
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6">
                ...
                {generations.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-purple-300 text-sm">Enter a prompt to create ultra-fast videos with VEO3 technology</p>
                  </div>
                ) : (
                  <div className="space-y-6">
                        ...
                        <div className="p-4">
                          ...
                          {generation.status === 'processing' && (
                            <div className="mb-4 bg-gradient-to-br from-violet-500/20 to-purple-500/20 rounded-lg p-8 text-center">
                              ...
                              <p className="text-violet-200">Generating ultra-fast video...</p>
                              <p className="text-violet-300 text-sm">This may take 2-5 minutes</p>
                            </div>
                          )}
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      <span className="text-purple-200">Audio Generated:</span>
                      <span className="text-white">{selectedGeneration.input_data?.generateAudio ? 'Yes' : 'No'}</span>
                    </div>
