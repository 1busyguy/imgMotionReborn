...
import { X, AlertTriangle, RefreshCw, Zap, Clock, CreditCard } from 'lucide-react';

const GenerationError = ({ generation, onRetry, canRetry = true }) => {
  const errorType = generation.metadata?.error_type || 'unknown_error';
  const errorCode = generation.metadata?.fal_error_details?.status_code;
    ...
    switch (errorType) {
      case 'content_violation':
        return {
          ...
          tips: 'Use family-friendly content and ensure your images are appropriate.'
        };
      case 'server_error':
        return {
          ...
          icon: Zap,
          title: 'Server Error',
          tips: 'This is temporary. Please try again in a few minutes.'
        };
      case 'bad_request':
        return {
      ...
      case 'rate_limit':
        return {
          ...
          icon: Clock,
          title: 'Rate Limited',
          tips: 'Please wait a moment before trying again.'
        };
      default:
        return {
