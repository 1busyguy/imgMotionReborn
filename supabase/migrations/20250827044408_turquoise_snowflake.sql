/*
  # Fix WAN 22 S2V Tool Type

  1. Database Changes
    - Update tool_type constraint to include correct 'fal_wan22_s2v' value
    - Ensure consistency with frontend tool type
...
-- Add the correct tool type to the constraint
