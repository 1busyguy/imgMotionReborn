/*
  # Add fal_omnihuman to tool_type constraint

  1. Database Changes
    - Add 'fal_omnihuman' to the ai_generations_tool_type_check constraint
    - Allows the Omnihuman tool to create generation records
...
-- Add fal_omnihuman to the tool_type check constraint
