/*
  # Fix WAN 22 S2V tool type naming

  1. Database Constraint Update
    - Add 'fal_wan22_s2v' to allowed tool types
    - Remove inconsistent 'wan22_s2v' if it exists
    - Ensure consistency with other fal_ prefixed tools
...
-- Add fal_wan22_s2v to the tool type constraint
