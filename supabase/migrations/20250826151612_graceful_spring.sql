/*
  # Add Gemini Flash Image Edit tool type to database constraint

  1. Database Changes
    - Update ai_generations_tool_type_check constraint to include 'fal_gemini_flash_image_edit'
    - This allows the new Gemini 2.5 Flash Image Edit tool to be stored in the database

  2. Tool Integration
    - Enables proper tool type tracking for the new AI image editing tool
    - Maintains data integrity while expanding available tool types
*/
