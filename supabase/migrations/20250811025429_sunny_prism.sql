/*
  # Add FLUX Kontext Max Multi Tool Type

  1. Database Changes
    - Add 'fal_flux_kontext_max_multi' to ai_generations tool_type constraint
    - Allows the new multi-image composition tool to create generation records
