...
serve(async (req) => {
  ...
  try {
    ...
    const queueUrl = `https://queue.fal.run/fal-ai/minimax/hailuo-02/standard/image-to-video?fal_webhook=${encodeURIComponent(webhookUrl)}`;
    ...
    console.log('✅ Minimax Hailuo request queued successfully, webhook will handle completion');
    ...
    return new Response(JSON.stringify({
      ...
      message: 'Minimax Hailuo video generation queued successfully. Webhook will update when complete.',
      fal_request_id: requestId,
